...
download.file("https://www.michigan.gov/documents/coronavirus/Cases_and_Deaths_by_County_and_Date_2020-10-08_704622_7.xlsx", destfile="./rawData/Cases_by_County_and_Date.xlsx")
...
dates <- c("08/24-8/27", "08/28-09/03", "09/04-09/10","09/11-09/17","09/18-09/24","09/25-10/02","10/03-10/09")
...
ferris <- c(4,19,34,45,18,29,32)
mecosta <- c(week1,week2,week3,week4,week5,week6,week7)
...
ferris_days <- c(4,11,18,22,23,24,25,26,29,30,31,32,33,36,37,38,39,40,43,44,45,46)
ferris_cases <- c(4,19,53,82,84,88,98,105,113,114,116,116,121,131,136,138,145,149,158,162,170,177)
