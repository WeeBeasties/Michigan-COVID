...
download.file("https://www.michigan.gov/documents/coronavirus/Cases_and_Deaths_by_County_and_Date_2020-08-28_700845_7.xlsx", destfile="./rawData/Cases_by_County_and_Date.xlsx")
...
```{r county_plot, echo=FALSE, message=FALSE, warning=FALSE, fig.width=12, fig.height=7, fig.cap="**Figure 4:** A comparison of the number of total cases in Isabella (including Central Michigan University, Mecosta (including Ferris State University) and Ottawa (including Grand Valley State University) counties. The bars indicate total daily cases and the lines are five-day moving averages."}
...
ggplot(counties, aes(x=Date, y=Cases, color=County)) +
  scale_colour_manual(values=c('mecosta'="firebrick", 'isabella'="dodgerblue", 'ottawa'="steelblue")) +
