...
download.file("https://www.michigan.gov/documents/coronavirus/Cases_by_County_and_Date_2020-09-07_701516_7.xlsx", destfile="./rawData/Cases_by_County_and_Date.xlsx")
...
```{r ferris_plot, echo=FALSE, message=FALSE, warning=FALSE, fig.width=12, fig.height=7, fig.cap="**Figure 6:** Mecosta caes (which includes Ferris State University). The bars indicate total daily cases and the lines are five-day moving averages. The vertical lines indicate the fourth of July, FSU opening on August 31st, and Labor Day."}
counties <- michiganTotalData %>% 
  filter(County == "mecosta")
ggplot(counties, aes(x=Date, y=Cases, color="firebrick", fill="firebrick")) +
  geom_bar(stat = "identity") +
  geom_ma(ma_fun = EMA, n = 5, wilder = TRUE, linetype = 1, size = 2) +
