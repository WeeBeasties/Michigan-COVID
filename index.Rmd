...
download.file("https://www.michigan.gov/documents/coronavirus/Cases_by_County_and_Date_2020-09-23_703157_7.xlsx", destfile="./rawData/Cases_by_County_and_Date.xlsx")
...
Figure 3 highlights the fact that deaths per capita is not equal across all counties. Seven counties (including the Detroit metropolitan area) and much higher. Nearly three dozen counties have normalized COVID-19 death rates lower than that of car fatalities in the state. 
...
dates <- c("08/24-8/27", "08/28-09/03", "09/04-09/10","9/11-9/17","9/18-9/24")
...
ferris <- c(4,19,34,45,18)
mecosta <- c(week1,week2,week3,week4,week5)
...
ferris_days <- c(4,11,18,22,23,24,25,26,29,30,31)
ferris_cases <- c(4,19,53,82,84,88,98,105,113,114,116)
